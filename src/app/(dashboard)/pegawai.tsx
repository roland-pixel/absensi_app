...
export default function PegawaiDashboard() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.badge}>Role: PEGAWAI</Text>
      <Text style={styles.title}>Dashboard Pegawai</Text>
      <Text style={styles.email}>{user?.email}</Text>

      <View style={styles.menuBox}>
        <Text style={styles.menuTitle}>Menu Utama:</Text>
        <Text>• Presensi Masuk / Pulang</Text>
...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: '#3b82f6', color: '#fff', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12, alignSelf: 'flex-start', fontWeight: 'bold', fontSize: 12 },
